...
class SalarySlip(TransactionBase):
	...
	def set_days(self):
		...
		if not self.leave and not self.present_days:
			...
			all_leave_with_start_date = frappe.db.get_all("Leave Application", {'employee':self.employee, "from_date":['between',[start,end]],'leave_type':['in',['Casual Leave','Sick Leave','Earned Leave','Leave Without Pay']],"docstatus":1},['from_date','to_date','total_leave_days'])
